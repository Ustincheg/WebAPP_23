setTimeout(init2slider('.range', '.range__between', '.range__button-1', '.range__button-2', '.range_input-1', '.range_input-2'), 0);

function init2slider(idX, btwX, btn1X, btn2X, input1, input2)
{
  document.get
  var slider  = document.querySelector(idX);
  var between = document.querySelector(btwX); 
  var button1 = document.querySelector(btn1X);
  var button2 = document.querySelector(btn2X);   
  var inpt1   = document.querySelector(input1); 
  var inpt2   = document.querySelector(input2); 
